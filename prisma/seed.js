...
async function main() {
  ...
  await prisma.requisito.createMany({
    data: [
      ...
      { texto: "REQUISITO 31 - Disponibiliza os links de acesso às seções 'Responsabilidade Fiscal', 'Ouvidoria', 'Fiscalização e Controle', 'Transferências', 'Receitas', 'Despesas', 'Obras', 'Patrimônio Público', 'Recursos Humanos', 'Licitações e Contratos', 'Acesso à Informação', 'Dados Abertos' e 'Participação' no Portal da Transparência de Pernambuco? (Pontuação: 6)", textoAjuda: "Este requisito verifica a disponibilização de 13 links obrigatórios do Portal da Transparência. A pontuação será proporcional à quantidade de links encontrados.", pontuacao: 8, linkFixo: null },
