...
async function main() {
  ...
  await prisma.requisito.createMany({
    data: [
      ...
      { texto: "REQUISITO 27 - Disponibiliza link de acesso à \"Carta de Serviços ao Usuário do órgão/entidade\" no Portal PE.GOV?", textoAjuda: "O link deve direcionar para o local específico onde a Carta de Serviços está divulgada no Portal PE Cidadão.", pontuacao: 4, linkFixo: 'https://pecidadao.pe.gov.br/' },
      ...
      { texto: "REQUISITO 33 - Disponibiliza os links de acesso às seções 'Responsabilidade Fiscal', 'Ouvidoria', 'Fiscalização e Controle', 'Transferências', 'Receitas', 'Despesas', 'Obras', 'Patrimônio Público', 'Recursos Humanos', 'Licitações e Contratos', 'Acesso à Informação', 'Dados Abertos' e 'Participação' no Portal da Transparência de Pernambuco? (Pontuação: 8)", textoAjuda: "Este requisito verifica a disponibilização de 11 links obrigatórios do Portal da Transparência. A pontuação será proporcional à quantidade de links encontrados.", pontuacao: 8, linkFixo: null },
